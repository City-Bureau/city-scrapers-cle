...
class CuyaOpiateTaskForceSpider(CuyaCountyMixin, CityScrapersSpider):
    ...
    def parse(self, response):
        today = datetime.now()
        payload = {
            "ctl00$ctl04": "ctl00$ContentPlaceHolder1$EventsCalendar1$updMainPanel|ctl00$ContentPlaceHolder1$EventsCalendar1$TabContainer1$tbpDateRange$btnShowDateRange",  # noqa
