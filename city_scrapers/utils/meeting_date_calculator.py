...
class MeetingDateCalculator:
    ...
    @staticmethod
    def calculate_upcoming_meeting_days(
        chosen_weekday, chosen_ordinals, start, end
    ):
        """
        ...
        while not (current_month == end.month and current_year == end.year):
            current_month_days = MeetingDateCalculator._calculate_meeting_days_per_month(
    ...
    def _calculate_meeting_days_per_month(
        chosen_weekday, chosen_ordinals, year, month
    ):
        """
        Lots of city meeting websites describe their upcoming meetings by saying
        things like: "this committee meets the 1st and 3rd Tuesday of every month".
