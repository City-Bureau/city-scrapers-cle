...
# Source:
# https://github.com/City-Bureau/city-scrapers-cle/blob/main/
# city_scrapers/spiders/cuya_emergency_services_advisory.py
async def scrape(
    ...
    await page.wait_for_selector(".bcyeargrid a")
    year_elements = await page.query_selector_all(".bcyeargrid a")
    for year_element in year_elements:
        await sdk.enqueue(await year_element.get_attribute("href"))
...
if __name__ == "__main__":
    asyncio.run(
        SDK.run(
            scrape,
            "https://bc.cuyahogacounty.us/en-US/CC-EmergencySrvcsAdvsryBrd.aspx",
            headless=False,
