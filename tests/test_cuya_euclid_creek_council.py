...
test_response = file_response(
    ...
    url="https://www.cuyahogaswcd.org/events/2019/03/21/euclid-creek-watershed-council-meeting",  # noqa
)
...
def test_id():
    assert (
        parsed_item["id"]
        == "cuya_euclid_creek_council/201903210800/x/euclid_creek_watershed_council"
    )
...
def test_source():
    assert (
        parsed_item["source"]
        == "https://www.cuyahogaswcd.org/events/2019/03/21/euclid-creek-watershed-council-meeting"  # noqa
    )
...
def test_links():
    assert parsed_item["links"] == [
        {
            "href": "https://www.cuyahogaswcd.org/files/events/ecwcchampionsprogram2019.pdf",  # noqa
        ...
        {
            "href": "https://www.cuyahogaswcd.org/files/events/ecwcdraftminutesjuly262018.pdf",  # noqa
            "title": "Minutes",
        },
        {
            "href": "https://www.cuyahogaswcd.org/files/events/pipe2019workplanfebruaryupdate.pdf",  # noqa
            "title": "pipe2019workplanfebruaryupdate.pdf",
        },
        {
            "href": "https://www.cuyahogaswcd.org/files/events/ecwc2019draftworkplan.pdf",  # noqa
            "title": "ecwc2019draftworkplan.pdf",
        },
        {
            "href": "https://www.cuyahogaswcd.org/files/events/2018-euclidcreekwatershedpechakuchaecwc.pdf",  # noqa
            "title": "2018-euclidcreekwatershedpechakuchaecwc.pdf",
        },
        {
            "href": "https://www.cuyahogaswcd.org/files/events/euclidcreeknps-is1.2draftforinput03132019.pdf",  # noqa
