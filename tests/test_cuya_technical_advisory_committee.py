...
def test_id():
    assert parsed_item[
        "id"] == "cuya_technical_advisory_committee/201908290930/x/technical_advisory_committee"
...
def test_source():
    assert parsed_item["source"] == "http://bc.cuyahogacounty.us/en-US/TACMeeting-082919.aspx"
